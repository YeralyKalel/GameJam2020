...
public class Pathfinding
{
    ...
    private List<PathNode> openList; //nodes that we are queueing up for searching
    private List<PathNode> closedList; //nodes that have already been searched/checked
